...
export default function Contactmap() {
    return (
        <div className='mt-24'>
            <div className=''>
                <div className='relative h-[px]450 mt-20 bg-Header flex items-center justify-center md:bg-dekstop bg-cover md:h-[660px] bg-bottom bg-no-repeat'>
                    <img src='/images/header/Frame 13.png' />
                    <div className='text-center font-semibold text-[28px] text-[#677487] absolute bottom-7 2xl:bottom-16 bg-white py-2 rounded-tr-[30px] w-[90%]'>
                        <h1>
                            Kontak
                        </h1>
                    </div>
                ...
                <div className='md:flex mx-16'>
                    <div className='font-medium text-base xl:text-lg text-[#677487] mt-10 mx-5 lg:mx-10 xl:mx-16 md:w-4/12'>
                        <div className='flex'>
