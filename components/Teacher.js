    ...
    <div className='mt-20'>
      ...
      <div className='flex flex-wrap mx-5 md:mx-9 lg:mx-12 xl:mx-16 2xl:mx-24'>
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/OTKP/mustofa.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/AKL/tati.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/erni.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/ade.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/emma.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/fadjar.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/suherman.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/AKL/dedi.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/BDP/tenni.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/BDP/mila.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/BDP/deria.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/BDP/intan.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/RPL/fajar.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/RPL/sandi.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/TKJ/rohandoko.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/Bahasa_Indonesia/imas.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/PAI/kusmawan.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/MTK/nuzwan.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/Bahasa_Inggris/suci.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          <img src='/images/guru/Bahasa_Inggris/inan.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        </div>
        ...
        <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
          ...
          <img src='/images/guru/BK/nurmansyah.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
        </div>
        </div>
        ...
        <p className='text-center font-semibold text-[28px] xl:text-4xl 2xl:text-5xl text-[#677487] mx-auto my-10'>Guru PJOK</p>
          <div className='py-5 flex flex-wrap justify-center gap-3 sm:gap-16 md:gap-20 2xl:gap-32  mx-auto'>
            ...
            <img src='/images/guru/PJOK/rahmat.png' alt='' className='w-36 md:w-40 lg:w-44 xl:w-60 ' />
          </div>
        </div>
