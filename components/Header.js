...
export default function Header() {
    return (
        <div className='container mx-auto'>
            <div className=''>
                <div className='relative w-full h-[362px] mt-20 bg-Header flex items-center justify-center'>
                    <img src='/images/header/Frame 13.png' className='' />

                    <div className='text-center font-semibold text-[28px] text-[#677487] absolute bottom-6 bg-white px-9 py-2 rounded-tr-[30px]'>
                        <h1>
                            Sejarah Singkat
                        </h1>
                    </div>
                ...
                <div className='mx-5'>
                    <div className='text-base font-normal leading-5 text-gray-800'>
                        <p>
                    ...
                    <div>
                        <div className='font-bold text-[#677487] text-2xl py-5 pt-8 '>
                            <p>Visi</p>
                        </div>
