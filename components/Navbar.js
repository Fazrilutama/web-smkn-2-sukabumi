        ...
        <div>
            <nav className='fixed top-0 left-0 right-0 z-50 w-full bg-white'>
                <div className='justify-between px-4 mx-auto xl:items-center xl:flex lg:px-16 xl:px-20'>
                    ...
                    <div>
                        <div className={`flex-1 justify-self-center pb-3 mt-8 xl:block xl:pb-0 xl:mt-0 ${navbar ? 'p-12 xl:p-0 block' : 'hidden'
                            }`} >
                            <ul className='items-center justify-center h-screen xl:h-auto xl:flex'>
