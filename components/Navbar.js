                ...
                <div>
                    <div className='flex items-center justify-between py-3 lg:py-5 lg:block'>
                        ...
                        <Link href="/" className='flex items-center lg:w-8/12'>
                            ...
                            <h2 className='pl-2 text-xl text-[#1e1916] font-bold w-48 lg:w-full'>Smkn Negeri 2 Kota Sukabumi</h2>
                        </Link>
                ...
                <div>
                    <div className={`flex-1 justify-self-center pb-3 mt-8 lg:block lg:pb-0 lg:mt-0 ${
                        ...
                        <ul className='h-screen lg:h-auto items-center justify-center lg:flex'>
                            ...
                            <li className='pb-6 text-lg text-[#1e1916] font-bold lg:py-3 py-2 lg:px-4 xl:px-6 text-center hover:text-white lg:bg-[#da251c] lg:text-white rounded-[30px] '>
